...
<!-- ======= Header ======= -->
  ...
  <p><br><br></p>
  <h1 style="font-size:50px;font-family:Times New Roman;color:black">Configuratie PC top-range</h1>
  <p><br><br></p>
  <p style="font-size:35px;font-family:Times New Roman;color:black">Nu știu dacă trebuie să ne mai facem probleme de rulare, ci de acum vom număra câte FPS-uri avem în X joc. E o discuție cu 4k, cu faptul că nici jocurile, nici plăcile video nu sunt încă la un nivel decent.
  ...
  <b><p style="font-size:35px;font-family:Times New Roman;color:red">-Carcasa Zalman Z11 Plus HF1, ATX Mid Tower, fara sursa, Negru</p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Placa de baza ASUS PRIME B460-PLUS </p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Procesor Intel Core i5-10400 Comet Lake, 2.9GHz, 12MB, Socket 1200</p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Solid-State Drive (SSD) Samsung 970 EVO Plus, 250 GB, NVMe, M.2</p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-HDD WD Caviar Blue 1TB SATA3 64MB 7200RPM </p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Sursa Seasonic S12III-650, 80+ Bronze, 650W </p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Placa video GIGABYTE GeForce RTX 2060 SUPER Windforce OC 8GB GDDR6 256-bit</p></b>
  </div>
<p>
<br>
<br>
