...
<!-- ======= Header ======= -->
  ...
  <p><br><br></p>
  <h1 style="font-size:50px;font-family:Times New Roman;color:black">Configuratie PC mid-range</h1>
  <p><br><br></p>
  <p style="font-size:35px;font-family:Times New Roman;color:black">Cu 3000 de lei facem super treabă. Pe rezoluții FULL HD nu avem probleme cu o configurație de 3000 de lei. Ne încadrăm spre un procesor AMD Ryzen de ultimă generație și putem pune și o placă video performantă. În wishlist-ul nostru am mers pe AMD. Dacă există buget va fi bine să mergeți și pe un SSD. Întotdeauna va fi util. Un exemplu de configuratie mid-range este:
  ...
  <b><p style="font-size:35px;font-family:Times New Roman;color:red">-Placa de baza MSI B450 GAMING PLUS ​MAX</p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Procesor AMD Ryzen 5 5600X 3.7GHz box </p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Sursa Seasonic S12III-650, 80+ Bronze, 650W </p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Carcasa Zalman Z11 Plus HF1, ATX Mid Tower, fara sursa, Negru </p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Memorie ADATA 8GB DDR4 2666MHz CL19 1.2v </p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Placa video GIGABYTE GeForce GTX 1650 OC, 4GB, GDDR5, 128-bit </p>
  <p style="font-size:35px;font-family:Times New Roman;color:red">-Hard disk Western Digital Caviar Blue 1TB SATA3 64MB </p></b>
  </div>
<p>
<br>
<br>
<br>
<center>
<img style=" width:400px; height:400px;"src="assets/img/carcasa2.jpg">
</center>
</p>
  </main><!-- End #main -->
