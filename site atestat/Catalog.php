...
<body>
 ...
 <div class="bootstrap-design">
    ...
    <h1 class="logo"><a href="Home.php">PC shop</a></h1>
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="nav-link scrollto " href="Home.php">Home</a></li>
          ...
          <li><a class="nav-link scrollto active" href="Catalog.php">Catalog</a></li>
  ...
  <div style="position: absolute; left:100px; top:200px;">
    <p> <b> Cauta </b> </p>
    <form method="POST">
      <input name = "search_bar" type="text" placeholder="cautare..." value='<?php if(isset($_POST['search_bar'])) echo $_POST['search_bar']?>' >
      <img src="assets/img/search.png" class="search" alt="" style="width:25px; cursor:pointer">
  ...
  <?php
    ...
    require("connection.php");
    $search = "SELECT * FROM produse ";

    $filtre;
    if(isset($_POST['search_bar']))
    {

        $cerinta = explode(" ", $_POST['search_bar']);

        $ok = 0;
        for($i = 0; $i < count($cerinta); $i++)
        {
              if($ok == 0)
              {
    ...
    ?>
        ...
        <div style="position: relative; top:<?php echo $top?>;">
              ...
              <?php
                  ...
                  if($row)
                  {
                    $pag = "detalii.php?id=".$row['id']; 
                    ?>
                    
                          <a href='<?php echo $pag?>' target = "_blank" style="color: black;">
                          <div style="position:absolute; left:12%;" class="card">
                              <img src='<?php echo $row['poza']?>' alt="Snow" style="width:300px; height: 200px;">
                              <h4 class="container"> <?php echo $row['nume']?> </h4>
                              <h4 class="container">Pret: <?php echo $row['pret']?> Lei</h4>
                          </div>
                          </a>
                    <?php
                  }
                  ...
                  if($row)
                  {
                    $pag = "detalii.php?id=".$row['id']; 
                    ?>
                          <a href='<?php echo $pag?>' style="color: black;">
                          <div style="position:absolute; left:36%;" class="card">
                              <img src='<?php echo $row['poza']?>' alt="Snow" style="width:300px; height: 200px;">
                              <h4 class="container"> <?php echo $row['nume']?> </h4>
                              <h4 class="container">Pret: <?php echo $row['pret']?> Lei</h4>
                          </div>
                  ...
                  if($row)
                  {
                    ...
                    ?>
                          ...
                          <a href='<?php echo $pag?>' style="color: black;">
                          <div style="position:absolute; left:60%;" class="card">
                              <img src='<?php echo $row['poza']?>' alt="Snow" style="width:300px; height: 200px;">
                              <h4 class="container"> <?php echo $row['nume']?> </h4>
                              <h4 class="container">Pret: <?php echo $row['pret']?> Lei</h4>
                          </div>
...
?>
  ...
  <footer id="footer" style='<?php echo "position: relative; top:".$top  ?>'  >
