<?php
    ...
    $nume1 = $row['nume'];
    $caracteristici = $row['caracteristici'];
    $pret = $row['pret'];
    $poza = $row['poza'];
...
<!-- ======= Header ======= -->
  <header id="header" class="d-flex align-items-center">
    ...
    <br>
    <br>
    <img src='<?php echo $poza?>' alt="Snow" style="width:400px; height: 300px;">
    <br>
    <br>
<table class="styled-table">
    <thead>
        <tr>
            <th>Nume Produs</th>
            <th><?php echo $nume1 ?></th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td>Descriere</td>
            <td><?php echo $caracteristici?></td>
        </tr>
...
<a href='<?php echo "adauga_in_cos.php?id=".$id; ?>' > <button type="submit"> Adauga in cos </button></a>
</div>
<p>
<br>
</p>
