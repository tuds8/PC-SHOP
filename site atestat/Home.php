 ...
 <!-- ======= Header ======= -->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      <h1>Bine ai venit la PC SHOP!</h1>
      <h2>Site-ul unde gasesti tot ce ai nevoie pentru calculatorul tau</h2>
      <a href="verifica.php" class="btn-get-started scrollto">Incepe cumparaturile</a>
    </div>
  </section><!-- End Hero -->
