 ...
 <!-- ======= Header ======= -->
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="Home.html">PC shop</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="Recenzii.php">Recenzii</a></li>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <span>Contact</span>
          <h2>Contact</h2>
          <p>Pentru mai multe informatii utilizati formularul de mai jos:</p>
        </div>
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              ...
              <p>Strada Ciocarliei, nr.3, Timisoara, Timis, Romania</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-box  mb-4">
              ...
              <h3>Trimiteti un email</h3>
              <p>PC_shop@gmail.com</p>
            </div>
          </div>
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-lg-6 ">
            <iframe class="mb-4 mb-lg-0" src="https://maps.google.com/maps?width=1000&amp;height=1000&amp;hl=en&amp;q=Strada Ciocârliei, Timișoara&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" frameborder="0" style="border:0; width: 100%; height: 384px;" allowfullscreen></iframe>
          </div>
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Numele dvs." required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Adresa dvs. de email" required>
                </div>
              </div>
              ...
              <div class="my-3">
                <div class="loading">Asteptati</div>
                <div class="error-message"></div>
                <div class="sent-message">Mesajul a fost trimis. Va multumim!</div>
              </div>
